...
**Cross-reference:** Always consult [communication-style.md](../../shared-context/communication-style.md) (GLOBAL WRITING STANDARD) first, then apply these specific rules for marketing and external communication.
...
**Single words (Ruben Hassid's 2025 list):**
...
**Jodie Cook's phrases (2025):**
"It's not X, it's Y", "While X is important, Y is crucial", "In fact", "Indeed", "First and foremost", "Next", "Finally", "As a result", "Therefore", "In other words", "To put it simply", "Not only X but also Y", "On one hand, on the other hand".
...
- Vary sentences: mix 5-word bursts with 30-word winds. High burstiness, no patterns.
...
- [Voice by Context](../01-VOICE-BY-CONTEXT/) - Context-specific voice adaptations
- [Channel-Specific Guides](../02-CHANNEL-SPECIFIC/) - Email, LinkedIn, scripts, etc.

---

*This document contains detailed rules for marketing and external communication. Always start with the [Communication Style Guide](../../shared-context/communication-style.md) for core voice principles, then apply these specific rules for external-facing content.*
